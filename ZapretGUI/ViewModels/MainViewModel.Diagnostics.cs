    ...
    private void ExportLogs()
    {
        try
        {
            var dialog = new Microsoft.Win32.SaveFileDialog
            {
                ...
                FileName = $"ZapretGUI_log_{DateTime.Now:yyyy-MM-dd_HH-mm-ss}.txt",
                Title = "Экспорт логов"
            };
            ...
            sb.AppendLine($"ZapretGUI v{AppVersion} — Лог от {DateTime.Now:dd.MM.yyyy HH:mm:ss}");
    ...
    private void ExportDiagnosticBundle()
    {
        try
        {
            var dialog = new Microsoft.Win32.SaveFileDialog
            {
                ...
                FileName = $"ZapretGUI_bundle_{DateTime.Now:yyyy-MM-dd_HH-mm-ss}.zip",
            ...
            {
                writer.WriteLine($"ZapretGUI v{AppVersion} — Системный лог [{DateTime.Now:dd.MM.yyyy HH:mm:ss}]");
            ...
            // ── Serilog лог-файлы из %LocalAppData%\ZapretGUI\logs ─────────────
