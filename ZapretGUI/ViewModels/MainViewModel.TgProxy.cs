...
public partial class MainViewModel
{
    ...
    // Оставлено только для совместимости со старыми ZapretGUI-settings.json.
    ...
    private async Task DownloadTgProxyAsync()
    {
        ...
        try
        {
            ...
            verHttp.DefaultRequestHeaders.Add("User-Agent", "ZapretGUI");
    ...
    private string BuildArguments()
    {
        ...
        // SNI/Fake-TLS домен намеренно не передаём: tg-ws-proxy в ZapretGUI работает через обычный dd-secret.
